...
//	mode: 'no-cors',
    ...
    //let jsObject = await fetch("https://gfkcm1eej6.execute-api.us-west-2.amazonaws.com/dev", requestOptions) //Prod Lambda (helloWorld //Prod Lambda (helloWorldAPI)	
    //let jsObject = await fetch(" https://fp7swzuv2evmy77hjqr3ehpsim0xztwk.lambda-url.us-west-2.on.aws/", requestOptions)
    //let jsObject = await fetch ("https://peu785drtd.execute-api.us-west-2.amazonaws.com/dev", requestOptions)
